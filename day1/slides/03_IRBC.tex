...
\subtitle{Session 3 --- Scaling up: the international real business cycle model}
...
\begin{enumerate}\itemsep1pt
    \item \texttt{03\_01\_IRBC\_DEQN\_smooth.ipynb} -- \emph{smooth benchmark, in-class walk-through (this lecture's \texttt{code/})}
    \begin{itemize}\itemsep0pt
    ...
    \item \texttt{03\_02\_IRBC\_DEQN\_irreversible.ipynb} -- \emph{irreversible-investment extension (this lecture's \texttt{code/})}
    \begin{itemize}\itemsep0pt
    ...
    \item \texttt{04\_04\_IRBC\_Exercise.ipynb} -- \emph{hands-on exercise (lives in L05's \texttt{code/})}
    \begin{itemize}\itemsep0pt
