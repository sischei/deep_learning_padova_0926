...
% Duration: 85 minutes, 30 before the first coffee break and 55 after it
% ============================================================================
...
% ---------- Title ----------
\title[DEQNs -- Padova 2026]%
{Deep Learning for Solving Dynamic Models}
\subtitle{Session 2: Deep Equilibrium Nets, the method and the Brock--Mirman benchmark}
...
\begin{tikzpicture}[
    ...
    \node[session] at (0.25,0.00) {Introduction to machine learning and deep learning};
    \fill[uzhblue] (0,0.00) circle (3.5pt);
    \node[time] at (-0.35,-0.56) {10:30--11:00};
    \node[now] at (0.25,-0.56) {Deep Equilibrium Nets I: motivation and the method};
    \fill[uzhblue] (0,-0.56) circle (3.5pt);
    \node[font=\tiny\bfseries, text=uzhblue, anchor=west] at (8.95,-0.56) {$\blacktriangleleft$ you are here};
    \node[pause] at (0.25,-1.12) {coffee break};
    \fill[uzhblue!30] (0,-1.12) circle (2pt);
    \node[time] at (-0.35,-1.68) {11:15--12:10};
    \node[now] at (0.25,-1.68) {Deep Equilibrium Nets II: Brock--Mirman, hands-on};
...
% --- Slide 3: Roadmap ---
\begin{frame}{Roadmap of This Lecture (85 min)}
\begin{columns}[T]
\column{0.48\textwidth}
\textbf{I.\ Motivation}~~\mbox{\small (15 min)}
\begin{itemize}\setlength\itemsep{1pt}
    \item Heterogeneity, high dimensions, kinks, irregular ergodic sets
\end{itemize}

\vspace{0.5em}
\textbf{II.\ From neural networks to DEQNs}~~\mbox{\small (15 min)}
\begin{itemize}\setlength\itemsep{1pt}
    \item Self-supervised loss, the training algorithm, where DEQNs sit
\end{itemize}

\vspace{0.5em}
\textbf{III.\ Brock--Mirman benchmark}~~\mbox{\small (35 min)}
\begin{itemize}\setlength\itemsep{1pt}
...
\column{0.48\textwidth}
\textbf{IV.--V.\ Loss balancing, NAS}~~\mbox{\small (Session 3)}
\begin{itemize}\setlength\itemsep{1pt}
    \item Pathologies (a) and (b) get their own session: 12:10 and 14:00
\end{itemize}

\vspace{0.5em}
\textbf{VI.\ Further pathologies, HPC, wrap-up}~~\mbox{\small (20 min)}
\begin{itemize}\setlength\itemsep{1pt}
...
\begin{itemize}\itemsep1pt
    ...
    \item \emphc{DeepHAM} (Han, Yang \& E 2026), heterogeneous agents
...
% --- Padova cut: section 4 "Loss Balancing" (378 lines) dropped ---
% --- Padova cut: section 5 "Architecture Search" (275 lines) dropped ---
...
% --- Hands-on preview ---
\begin{frame}{Hands-On: Build a DEQN Yourself}
...
\vspace{0.4em}
{\footnotesize Loss kernels are compared in \texttt{02\_05}. Architecture search and loss balancing follow in Session 3 (\texttt{03\_01}, \texttt{03\_02}, \texttt{03\_03}), on a Genz testbed and then on this Brock--Mirman model.}
...
\vspace{8pt}
{\small Freely available: \href{https://github.com/sischei/deep_learning_padova_0926}{the book repository on GitHub}}
\end{columns}
\end{frame}
...
\vspace{0.6cm}
{\small Next up: architecture search and loss balancing (Session 3)}\\[6pt]
{\small Materials:}\\[3pt]
{\footnotesize\href{https://github.com/sischei/deep_learning_padova_0926}{github.com/sischei/deep\_learning\_padova\_0926}}\\[4pt]
