...
\end{center}
{\scriptsize Stored teaching run of \texttt{03\_03}, Section 7: ReLoBRaLo with per-step updates, three seeds per temperature, median and range of the total relative error against the equal-weighting and natural-units levels.}
