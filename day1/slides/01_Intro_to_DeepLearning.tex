...
\begin{tikzpicture}[
    ...
    \draw[uzhblue!30, line width=2pt] (0,0.45) -- (0,-4.76);
    \node[time] at (-0.35,0.00) {09:00--10:30};
    ...
    \node[time] at (-0.35,-1.24) {10:45--12:00};
    \node[session] at (0.25,-1.24) {Deep Equilibrium Nets and Brock--Mirman};
    \fill[uzhblue] (0,-1.24) circle (3.5pt);
    \node[pause] at (0.25,-1.86) {lunch break};
    \fill[uzhblue!30] (0,-1.86) circle (2pt);
    \node[time] at (-0.35,-2.48) {13:30--14:25};
    \node[session] at (0.25,-2.48) {Architecture search and loss balancing};
    \fill[uzhblue] (0,-2.48) circle (3.5pt);
    \node[time] at (-0.35,-3.10) {14:25--15:25};
    \node[session] at (0.25,-3.10) {Overlapping generations with DEQNs};
    \fill[uzhblue] (0,-3.10) circle (3.5pt);
    \node[pause] at (0.25,-3.72) {coffee break};
    \fill[uzhblue!30] (0,-3.72) circle (2pt);
    \node[time] at (-0.35,-4.34) {15:40--16:30};
    \node[session] at (0.25,-4.34) {IRBC with DEQNs};
    \fill[uzhblue] (0,-4.34) circle (3.5pt);
\end{tikzpicture}
\end{center}
\end{frame}
