...
\vspace{0.3em}
\textbf{The computation.}  State dimension is \emphc{linear in $N$}: $2N$ (capital and TFP per
country). Smooth but highly nonlinear; the planner's problem gives a clean target; the standard
