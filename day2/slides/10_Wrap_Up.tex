...
8--9 & Continuous time: PINNs, then the HJB--KFE system \\
\bottomrule
\end{tabular}
\end{center}
...
\node[phasebox, fill=softgreen!25]  (s8) at (10.8,0) {S8--S9\\PINNs, CT-HA};
...
\begin{itemize}\itemsep4pt
  ...
  \item \textbf{The master equation and EMINNs} --- aggregate shocks in
