...
% Duration: 20 minutes, plus closing questions
% ============================================================================
...
3 & Making training work: architecture search and loss balancing \\
4 & Cohort structure and constraints (OLG, 56 generations) \\
5 & Scaling to a 2N-dimensional state space (IRBC) \\
...
\node[phasebox, fill=softblue!25]   (s2) at (2.7,0)  {S2--S3\\DEQNs, tuning};
\node[phasebox, fill=softblue!25]   (s4) at (5.4,0)  {S4--S5\\OLG, IRBC};
