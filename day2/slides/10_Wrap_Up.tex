...
\begin{itemize}\itemsep4pt
  ...
  \item \textbf{Continuous-time heterogeneous agents} --- the coupled HJB--KFE system,
        continuous-time Aiyagari, and the master equation.  Slides and a runnable notebook are in
        \texttt{day2/optional\_continuous\_time\_ha/}, as optional self-study.
