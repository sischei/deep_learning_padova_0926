...
% --- Slide 4: Roadmap ---
\begin{frame}{Roadmap of This Session}
...
\vspace{0.5em}
\textbf{Hands-on}: build a PINN from scratch, at the keyboard.

\vspace{0.3em}
\textbf{Wrap-up}: what to use when, where to go next, and closing questions.
\end{frame}
