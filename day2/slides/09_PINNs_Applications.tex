...
% Session 9 of the Padova suite, 30 minutes of slides plus hands-on and wrap-up
% ============================================================================
...
\footnotesize
A fill-in-the-blank PINN for $u''+u=0$ on $[0,\pi/2]$, $u(0)=0$, $u(\pi/2)=1$, solution $\sin x$; 12 minutes, solutions follow each task. Bonus at home: hard BCs, and why the same equation on $[0,\pi]$ with zero boundary values is ill-posed: every $c\sin x$ solves it, and the network returns $u \equiv 0$ at a loss of $10^{-6}$.
\end{exampleblock}
\end{frame}
