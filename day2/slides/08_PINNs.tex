...
% ---------- Title ----------
\title[PINNs -- Padova 2026]%
{Deep Learning for Solving Dynamic Models}
\subtitle{Session 8 --- Economics-informed neural networks}
...
\vspace{0.3em}
{\footnotesize On Day 1 this bought $\approx 110\times$ over equal weighting, where the best adaptive scheme managed $2\times$ (\texttt{02\_DeepEquilibriumNets.pdf}, Part IV). See Wang, Teng \& Perdikaris (2021).}
\end{frame}
