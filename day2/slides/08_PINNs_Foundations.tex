...
\begin{tikzpicture}[
    ...
    \node[now] at (0.25,-2.8) {PINNs I: foundations};
    ...
    \node[session] at (0.25,-4.2) {PINNs II: applications, hands-on, wrap-up};
...
% --- Slide 4: Roadmap ---
\begin{frame}{Roadmap of This Session (55 min)}
\textbf{Part I of two.}  This session builds the method; Session 9 after the break applies it to
economic and financial models.

\vspace{0.6em}
\textbf{I.\ From DEQNs to PINNs}~~\mbox{\small (12 min)}
...
\vspace{0.5em}
\textbf{III.\ Boundary conditions}~~\mbox{\small (23 min)}
\begin{itemize}\setlength\itemsep{1pt}
...
Day 1 solved equilibrium conditions in \emphc{discrete} time with DEQNs. This afternoon we do the \emphc{continuous-time} counterpart. Coupling the HJB to a Kolmogorov forward equation, for heterogeneous agents, is the optional material in \texttt{day2/optional\_continuous\_time\_ha}.
\end{block}
\end{frame}
