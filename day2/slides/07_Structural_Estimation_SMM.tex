...
\begin{tikzpicture}[
    ...
    \node[now] at (0.25,-0.62) {Structural estimation via SMM};
    \fill[uzhblue] (0,-0.62) circle (3.5pt);
    \node[font=\tiny\bfseries, text=uzhblue, anchor=south east] at (8.85,-0.28) {you are here $\blacktriangledown$};
...
\textbf{I.\ The idea}~~\mbox{\small (10 min)}
...
\vspace{0.4em}
\textbf{II.\ One parameter}~~\mbox{\small (15 min)}
\begin{itemize}\setlength\itemsep{1pt}
...
\column{0.48\textwidth}
\textbf{III.\ Two parameters}~~\mbox{\small (12 min)}
\begin{itemize}\setlength\itemsep{1pt}
...
\vspace{0.4em}
\textbf{Finger exercise, production, hands-on}~~\mbox{\small (8 min)}
\end{columns}
